...
# lolipop-indicator-graph -------------------------------------------------



region_indicator_avg |>
  filter(family_name == "Justice Institutions") |>
  ggplot(aes(x = var_name, y = avg_score)) +
  ...
  labs(
    ...
    subtitle = "Justice Institutions, Latin America & Caribbean",
    x        = "Indicator",
...
ggsave_db(
  here("figures", "regional_ctf_indicator_Justice_Institutions.png")
